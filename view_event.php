...
<!-- Mirrored from echotheme.com/educati/page-event-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Apr 2019 18:42:25 GMT -->
<head>
    <meta charset="UTF-8">
       ...
       <div class="card shadow-v1">
         ...
         <div class="card-body padding-40">
           ...
           <ul class="nav tab-line tab-line border-bottom my-4 text-gray" role="tablist">
             ...
             <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#Tabs_1-2" role="tab" aria-selected="false">
                Speakers
              </a>
             </li>
             <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#Tabs_1-3" role="tab" aria-selected="false">
                Schedule
              </a>
             </li>
             <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#Tabs_1-4" role="tab" aria-selected="false">
                Sponsors
              </a>
             </li>
             <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#Tabs_1-5" role="tab" aria-selected="false">
                Map
              </a>
             </li>
           </ul>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade active show" id="Tabs_1-1" role="tabpanel">
               ...
               <p>
                  Dummy text of the printing and typesetting industry. It was popularised in the kest with the release of Letraset sheets contain luing lorem Ipsum passages, and more recently with desktop publishing software.
               </p>
               <h4 class="my-3">
                ...
                <p>
                  Investig ationes demons travge vunt lectores legee lrus quodk legunt saepius was
                  claritas kesty conctetur kedadip sicing. Dummy text of the printing and typesetting 
                  industry. It was popularised in the 1960s with the release of Letraset sheets contain luing lorem Ipsum passages, and more recently with desktop.
                </p>
                <h4 class="my-3">
              ...
              <div class="tab-pane fade" id="Tabs_1-2" role="tabpanel">
                  ...
                  <div class="col-12">
                   ...
                   <div class="col-md-4 mt-4">
                     <div class="card text-center">
                       <img src="assets/img/262x230/5.jpg" width="203" height="203" class="rounded-circle" alt="">
                       <h6 class="mt-3 mb-1">
                         Dorian Black
                       </h6>
                       <p class="text-gray">
                   ...
                   <div class="col-md-4 mt-4">
                     <div class="card text-center">
                       <img src="assets/img/262x230/6.jpg" width="203" height="203" class="rounded-circle" alt="">
                       <h6 class="mt-3 mb-1">
                         Alice Williams
                       </h6>
                       <p class="text-gray">
                   ...
                   <div class="col-md-4 mt-4">
                     <div class="card text-center">
                       <img src="assets/img/262x230/7.jpg" width="203" height="203" class="rounded-circle" alt="">
                       <h6 class="mt-3 mb-1">
                         Nurjaman
                       </h6>
                       <p class="text-gray">
                 ...
                 <div class="row mt-5">
                  <div class="col-12">
                   ...
                   <div class="col-md-4 mt-4">
                     <div class="card text-center">
                       <img src="assets/img/262x230/8.jpg" width="203" height="203" class="rounded-circle" alt="">
                       <h6 class="mt-3 mb-1">
                         Dorian Black
                       </h6>
                       <p class="text-gray">
                   ...
                   <div class="col-md-4 mt-4">
                     <div class="card text-center">
                       <img src="assets/img/262x230/10.jpg" width="203" height="203" class="rounded-circle" alt="">
                       <h6 class="mt-3 mb-1">
                         Nurjaman
                       </h6>
                       <p class="text-gray">
              ...
              <div class="tab-pane fade" id="Tabs_1-3" role="tabpanel">
                ...
                <p>
                  9:00 AM – 6:00 PM (Gates Open at 8:30 AM)
                </p>
                <div class="mt-4">                
                    ...
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th scope="col" class="font-weight-bold">Session</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
      ...
      <div class="col-lg-4 mt-4">
        <div class="card shadow-v1">
          <div class="card-body">
            ...
            <div class="border-bottom py-3">
              <div class="media">
                ...
                <div class="media-body ml-3">
                  ...
                  <span>South Street, London, UK</span>
                </div>
              </div>
            </div>
            ...
            <div class="border-bottom py-3">
              <div class="media">
                <i class="ti-credit-card text-primary mt-2"></i>
                <div class="media-body ml-3">
                  <h6 class="my-0">Cost <span class="badge badge-primary ml-2">$250</span></h6>
                </div>
              </div>
            </div>
            <a href="#" class="btn btn-primary marginTop-40">Buy Ticket</a>
          </div>
        </div>
        ...
        <div class="card shadow-v1 mt-4">
          <div class="card-body">
            ...
            <p>
              Investig ationes demons travge is vunt lectores legee kedlrus quodk legunt saepius was claritas.
            </p>
...
<!-- Mirrored from echotheme.com/educati/page-event-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Apr 2019 18:42:49 GMT -->
</html>