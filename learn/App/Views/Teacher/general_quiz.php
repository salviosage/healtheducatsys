...
if(isset($_GET['course']) && $_GET['course']!='' && isset($_GET['title']) && $_GET['title']!=''){
    ...
    //$addcourseUrl="?request=add_course_course&title=".$title."&course=".$course_id;
    //load course courses
    $Quizes=$admin->getQuiz($course_id);
    ...
    <div class="col-sm-12">
        <div class="card-box table-responsive" style="border: none;">
            <h4 class="m-t-0 header-title"><b>Available Quizes (Questions and Answers)</b>
                ...
                if(count($Quizes)==0){
                    ?>
                    <button id="btnAddQuiz" credit="<?php echo $course_id; ?>" title="<?php echo $title; ?>" class="btn btn-primary waves-effect waves-light pull-right">ADD NEW QUIZ</button>
                    <?php
                }
                ?>
