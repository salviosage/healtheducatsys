<?php 
$Subscribers=$admin->getNewsLetterSubscribers();
?>
<div class="row">
    <div class="col-sm-12">
        <div class="card-box table-responsive">
            <h4 class="m-t-0 header-title"><b>Newsletter Subscribers</b></h4>
                            ...
                            <tr role="row" class="even">
                                ...
                                <td>
                                    <div class="btn-group m-b-10">
                                        <button message_id="<?php echo $value['id']; ?>"  class="btn btn-info btn-sm waves-effect btn_view_message">
                                            <i class="fa fa-eye"></i>
                                        </button>
